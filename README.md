...
1. **Supabase**（数据库 + 登录）
   ...
   - SQL Editor：依次粘贴执行 `supabase/01_schema.sql`、`supabase/02_seed_products.sql`、`supabase/03_customer_accounts_and_admin_roles.sql`、`supabase/04_carts_and_tracking.sql`
